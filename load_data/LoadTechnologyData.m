...
if sum(~isnan(cell2mat(raw(15,2:end)))) > 0 && sum(~isnan(cell2mat(raw(16,2:end)))) > 0 && sum(~isnan(cell2mat(raw(17,2:end)))) > 0
    technologies.storage_techs_min_temperature = cell2mat(raw(15,2:end));
    technologies.storage_techs_max_temperature = cell2mat(raw(16,2:end));
    technologies.storage_techs_specific_heat = cell2mat(raw(17,2:end));
end
